...
def train(net, loss_fn, train_data_path, train_label_path, test_data_path, test_label_path, batch_size, optimizer, load_file, save_as, epoches=1, patience=5):
    best_loss = 1e3
    best_model = net
...
if __name__ == "__main__": 
    layers = [
        ...
        {'name': 'Relu'},
        # {'name': 'Dropout', 'hyperparam': {'drop_rate': 0.3}},
    ...
    train(net, loss_fn, *data_files, batch_size, optimizer, None, None, epoches=100, patience=10)
